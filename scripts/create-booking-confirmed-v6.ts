// booking_confirmed_v6 — the v5 layout (no greeting, human date, "Class at
// 7:00 am") PLUS a one-tap cancel link. 5 variables: {{1}} date, {{2}} start
// time, {{3}} ticket, {{4}} location, {{5}} wa.me cancel link.
//
// Run:
//   DOTENV_CONFIG_PATH=.env.vercel npx tsx scripts/create-booking-confirmed-v6.ts
//
// After APPROVED, set in Vercel:
//   WHATSAPP_TEMPLATE_BOOKING_CONFIRMATION=booking_confirmed_v6

import "dotenv/config"

const WABA_ID = "1571637721189360"
const GRAPH = "https://graph.facebook.com/v21.0"
const NAME = "booking_confirmed_v6"
...
async function main() {
        ...
        { type: "HEADER", format: "TEXT", text: "Gravity Stretching Canggu" },
        {
          ...
          example: {
            body_text: [[
              ...
              "https://wa.me/628213130468?text=Cancel%20474",
            ]],
          },
        },
      ],
  ...
  console.log("Wait for APPROVED, then set Vercel env WHATSAPP_TEMPLATE_BOOKING_CONFIRMATION=booking_confirmed_v6")
}
