// booking_confirmed_v10 — owner's wording + one closing line (needed to pass
// Meta's parameter-to-word ratio). 4 body vars + quick-reply "Cancel booking".
...
const NAME = "booking_confirmed_v10"
